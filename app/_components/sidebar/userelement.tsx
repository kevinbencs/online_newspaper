...
const UserElement = (props: { setCheckboxValue: Dispatcher<boolean> }) => {
    ...
    return (
        <>
            ...
            {RoleLogged === 'Admin' &&
                <li><Link onClick={checked} href='/writecarrier' className='pt-1 pb-1 bg-neutral text-neutral-content mt-2 ml-2 mr-2 md:text-xl text-base  rounded-[4px] hover:bg-slate-100 hover:text-black flex justify-center gap-2'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
