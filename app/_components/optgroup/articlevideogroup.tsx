        ...
        <div className='lg:w-[calc(60%+20px)] w-full'>
            ...
            <div>
                ...
                <div className='relative'>
                    ...
                    <input type="text" placeholder='id' value={videoId} readOnly className={`focus-within:outline-none input-bordered border-b-2 block w-full bg-transparent pl-2 min-h-[26px] mb-10 `} />
