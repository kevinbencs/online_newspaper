    ...
    return (
        <>
            ...
            <label className='relative w-full mb-4 block'>
                <input ref={optRef} type="text" name='search_image' onFocus={() => setOptClass('h-52')} onBlur={() => {setOptClass('h-0');}} className='focus-within:outline-none input-bordered border-b-2 block w-full bg-transparent pl-2' placeholder='Audio url' value={optInput} onChange={handleChange} disabled={props.isPending} />
