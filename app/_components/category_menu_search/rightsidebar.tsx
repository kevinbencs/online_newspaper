    ...
    return (
        <div className='ml-2 lg:ml-0 mr-2 lg:mr-0 '>
            <Link href='https://x.com/' className='block text-center bg-black mb-24 text-white rounded hover:text-white dark:hover:text-white pt-5 pb-5'>
                ...
                <div className='text-lg mb-3 flex items-center justify-center gap-1'>
            ...
            <div className='max-w-[400px] ml-2 lg:ml-0'>
                <Link href='/latest/1' className='mb-2 flex items-center gap-2'>
                ...
                <section>
                    ...
                    {latest.success && <>
                        {latest.success.map(item => <div key={item.id}>
                            <Link href={`/category/${item.category.toLowerCase()}`} className='category top-3 uppercase drop-shadow-md font-bold text-[10px] '>{item.category}</Link>
