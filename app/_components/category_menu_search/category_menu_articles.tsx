...
const Category_menu_articles = (props: { imageId: string, title: string, detail: string, category_name: string, category_name_link: string, date: string, link: string, paywall: boolean }) => {
