  ...
  return (
    <section className="join mb-10">
        {(props.searchParams.page > 2 && props.lastPage > 3) &&
          <Link href={`/important?page=${1}`} className="join-item btn btn-square">
        ...
        {props.searchParams.page > 1 &&
          <Link href={`/important?page=${props.searchParams.page - 1}`} className="join-item btn btn-square">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
        ...
        {props.searchParams.page < props.lastPage &&
          <Link href={`/important?page=${Number(props.searchParams.page) + 1}`} className="join-item btn btn-square">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
        ...
        {(props.lastPage > 3 && props.searchParams.page < props.lastPage - 1) &&
          <Link href={`/important?page=${props.lastPage}`} className="join-item btn btn-square">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
