            ...
            <div className='lg:w-[680px] w-full'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='flex justify-end items-center'>
                        <input type="text" name="task" id='task' className='w-full h-10 pl-2 p-1 rounded-lg border border-gray-700' value={inputValue} onChange={(e) => setINputValue(e.target.value)} />
