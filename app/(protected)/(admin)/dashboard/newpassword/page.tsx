  ...
  return (
    <div className='w-full lg:w-[500px]'>
      ...
      <form onSubmit={handleSubmit} className='text-center md:text-start'>
        <input type="password" className='p-1 pl-2 border-gray-800 border rounded w-full mb-2' name="password" required placeholder='Password' value={password} onChange={(e) => setPassword(e.target.value)} disabled={isPending} />
        <input type="password" className='p-1 pl-2 border-gray-800 border rounded w-full mb-2' name="confirm_password" required placeholder='Confirm password' disabled={isPending} value={passwordConfirm} onChange={(e) => setPasswordConfirm(e.target.value)} />
