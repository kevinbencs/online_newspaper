  ...
  return (
    <div className='lg:flex lg:gap-48 mt-32 min-h-screen relative'>
        <section className='flex justify-center lg:flex-col gap-2 mb-8 lg:justify-start flex-wrap flex-col md:flex-row'>
            ...
            <Link className='border-zinc-500 border hover:dark:bg-slate-500 hover:text-white hover:dark:text-white hover:bg-gray-700 text-center inline-block p-2 min-w-32' href={'/dashboard/category_image_audio_video'}>Video, category, image, audio</Link>
