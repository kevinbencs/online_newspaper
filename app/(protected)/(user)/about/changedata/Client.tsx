...
const Client = (props: {
    ...
    useEffect(() => {
                ...
                if (props.userData.error) setError(props.userData.error);
                else {
                    if (props.userData.name) setName(props.userData.name);
                    if (props.userData.email) setEmail(props.userData.email);
                    if (props.userData.subscribe) setSubscribe(props.userData.subscribe)
                }

                if(props.savedArticle.error) setError(props.savedArticle.error);
                if(props.savedArticle.Error) setError(props.savedArticle.Error);
                if (props.savedArticle.data) setArticles(props.savedArticle.data)
