    ...
    <div className='flex justify-center h-[90vh] pt-[10vh]'>
      <div className='w-80'>
        ...
        <section className='mt-10'>
          ...
          <button onClick={handleFacebookSignIn} className='w-[100%] pl-16 rounded-lg  p-2 text-white cursor-pointer  bg-[#0866ff] flex items-center  gap-4 mt-5 shadow-[0_0_10px_2px_rgba(0,0,0,0.1)]'><FaFacebook className='h-5 w-5' /> Sign in with Facebook</button>
