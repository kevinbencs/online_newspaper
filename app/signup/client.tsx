        ...
        <div className='flex justify-center min-h-[90vh] pt-[20vh]'>
            <div className='w-[90%] max-w-[800px]'>
                <form action="" onSubmit={handleSubmit} className='relative'>
                    ...
                    <input type="text" id='name' autoComplete='name' placeholder='Fill your name' disabled={isPending} className={`dark:text-white bg-transparent bg-user bg-no-repeat bg-[length:28px] bg-[left_top_7px]  border-b-2 border-base-content block w-full pl-10 p-2 pb-2 imageClass ${nameClass}  focus-visible:outline-none`} name='name' value={inputValue.name} onChange={handleInputChange} required tabIndex={0} />
                    <input type="email" id='email' autoComplete='email' placeholder='Fill your email' disabled={isPending} required name='email' className={`dark:text-white bg-transparent bg-email bg-[length:24px] bg-[left_top_7px] bg-no-repeat  border-b-2 border-base-content pl-10 block w-full imageClass p-2 ${emailClass} focus-visible:outline-none`} value={inputValue.email} onChange={handleInputChange} tabIndex={0} />

                    <div className={`flex justify-end ${passwordClass}`}>
                        <input type={showPassword} placeholder='Fill your password' disabled={isPending} required name='password' maxLength={16} className={`${passwordClass} dark:text-white bg-transparent bg-password bg-[length:24px] bg-[left_top_7px] pl-10 bg-no-repeat border-b-2 border-base-content block w-full p-2 imageClass focus-visible:outline-none`} id='password' value={inputValue.password} onChange={handleInputChange} tabIndex={0} />
